...
\subsection{ Differentiability in Higher Dimensions }
    ...
    \begin{tbox}
        ...
        \hspace{0.5cm}
        D(g $\circ$ f)(u,v)
        = D(u+v+uv,$\frac{v}{u}$,u+v-uv)

        \hspace{0.5cm}
        = $\begin{bmatrix}
            \frac{\partial}{\partial u} u+v+uv
            & \frac{\partial}{\partial v} u+v+uv \\

            \frac{\partial}{\partial u} \frac{v}{u}
            & \frac{\partial}{\partial v} \frac{v}{u} \\
        ...
        \begin{bmatrix}
            ...
            \frac{\partial}{\partial x} \frac{z}{y}
            & \frac{\partial}{\partial y} \frac{z}{y}
            & \frac{\partial}{\partial z} \frac{z}{y} \\

            \frac{\partial}{\partial x} x-y
            & \frac{\partial}{\partial y} x-y
            & \frac{\partial}{\partial z} x-y
        \end{bmatrix}_{\underset{\underset{z=v^2}{y=uv}}{x=u+v}}
        \begin{bmatrix}
            \frac{\partial}{\partial u} u+v
            & \frac{\partial}{\partial v} u+v \\

            \frac{\partial}{\partial u} uv
            & \frac{\partial}{\partial v} uv \\

            \frac{\partial}{\partial u} v^2
